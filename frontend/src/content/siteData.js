export const artist = {
  name: "KUSANG LHAMO",
  title: "3D Artist · Game Art Student",
  intro:
...
export const skills = [
  ...
  { name: "Adobe Substance Painter", category: "Texturing" },
  { name: "Adobe Substance 3D Modeler", category: "Modeling" },
  { name: "Adobe Substance 3D Sampler", category: "Texturing" },
  { name: "Unreal Engine", category: "Real-time" },
  { name: "Adobe Photoshop", category: "Post-processing" },
  { name: "SpeedTree", category: "Vegetation" },
  { name: "Adobe Premiere Pro", category: "Video" },
  { name: "Marmoset Toolbag", category: "Rendering" },
];
